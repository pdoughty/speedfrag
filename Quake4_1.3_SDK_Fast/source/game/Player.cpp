...
// PHIL BEGIN
			...
			playerView.Flash( colorWhite, 400 );
			if ( mphud ) {
				mphud->SetStateString( "main_notice_text", common->GetLocalizedString( "CRACK TRIP\n" ) );
				mphud->HandleNamedEvent( "main_notice" );
...
// PHIL BEGIN			
	...
	//dir[2] = 0;
			//Damage( NULL, NULL, dir, "damage_triggerhurt_1000", 1.0f, INVALID_JOINT );
			Kill( false, false );
			if ( mphud ) {
				mphud->SetStateString( "main_notice_text", common->GetLocalizedString( "OVERDOSE\n" ) );
				mphud->HandleNamedEvent( "main_notice" );
			}
// PHIL END
